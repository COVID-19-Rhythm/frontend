      ...
      <div className="researhChildParent">
        <div className="researchChild">
          <div className="greyBackground">
            <h1>Research</h1>
            <p>
              Current research conducted by doctors, researchers and scientists
              at Stanford and Mount Sinai Hospital have indicated that the
              detection of COVID-19, even if the patient is asymptomatic, can be
              detected through everyday devices such as the apple watch.{" "}
            </p>
            <p>
